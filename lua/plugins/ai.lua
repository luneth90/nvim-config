			...
			require("opencode").setup({
				...
				keymap = {
					...
					input_window = {
						...
						["<leader>ov"] = { "paste_image", mode = "i" }, -- Paste image from clipboard as attachment
						...
						["<leader>cv"] = { "cycle_variant", mode = { "n", "i" } }, -- Cycle through available model variants
					},
					output_window = {
						["<esc>"] = { "close" }, -- Close UI windows
						["<C-c>"] = { "cancel" }, -- Cancel opencode request while it is running
						...
						["<leader>cv"] = { "cycle_variant", mode = { "n" } }, -- Cycle through available model variants
